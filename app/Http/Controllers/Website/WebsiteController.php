...
class WebsiteController extends Controller
{
    ...
    {  
        $this->theme = env('ACTIVE_THEME','myweb');
    ...
    public function about(Request $request){
        return view ('theme.myweb.about-us');
    }
    public function benefits(Request $request){
        return view ('theme.myweb.benefits');
    }
    public function patience_register(Request $request){
        return view ('theme.myweb.patient-register-portal');

  
    }
    public function login(Request $request){
        return view ('theme.myweb.login');
  
    }
    public function blogs(Request $request){
        return view ('theme.myweb.blogs');

  
    }
    public function patientadditionalimplant(Request $request){
        return view ('theme.myweb.patient-additional-implant');

  
    }
    public function patientregisterportal(Request $request){
        return view ('theme.myweb.patient-register-portal');
    }
    public function pricing(Request $request){
        return view ('theme.myweb.pricing');
    }
    public function privacy_policy(Request $request){
        return view ('theme.myweb.privacy-policy');
    }
    public function services(Request $request){
        return view ('theme.myweb.services');
    }
    public function signup(Request $request){
        return view ('theme.myweb.signup');
    }
    public function termsandcondition(Request $request){
        return view ('theme.myweb.terms-and-condition');
    }
    public function testimonials(Request $request){
        return view ('theme.myweb.testimonials');
    }
    public function faqs(Request $request){
        return view ('theme.myweb.faqs');
    }
    public function contact(Request $request){
        return view ('theme.myweb.contact-us');
    }
    public function doctorregisterportal(Request $request){
        return view ('theme.myweb.doctor-register-portal');
    }
    public function doctoraddionalimplant(Request $request){
        return view ('theme.myweb.doctor-addional-implant');
    }
    public function userDashboard(Request $request){
        return view ('theme.myweb.userDashboard.patienteList');
    }
    public function viewPatient(Request $request,$id){
        $patiente=DoctorRegisterPortal::find($id);
        return view ('theme.myweb.userDashboard.patienteView',['patiente'=>$patiente]);
    }
    public function sharePatient(Request $request,$id){
        $patiente=DoctorRegisterPortal::find($id);
        return view ('theme.myweb.userDashboard.share',['patiente'=>$patiente]);
    }
    public function AllowEditing(Request $request){
        return view ('theme.myweb.AllowEditing');
    }
    public function updateProfile(Request $request){
        return view ('theme.myweb.userDashboard.updateProfile');
    }
    public function changePassword(Request $request){
        return view ('theme.myweb.userDashboard.changePassword');
    }
    public function doctor_register_portal(Request $request){
        if(Auth::check()){
        return view ('theme.myweb.userDashboard.doctor_register_portal');
        }else{
            return redirect()->back()->with("error",'First you must login!');
        }
    }
    public function patientChangePassword(Request $request){
        return view ('theme.myweb.setPassword');
    }

    public function brandData($manufacurer_id)
    {
       
        // return $manufacurer_id; 
        $brands = Brand::where('manufacturer_id', $manufacurer_id)->get();
        return response()->json($brands);
    }
    public function diameter_session($state_id)
    {
        $platform = Diameter::where('brand_id', $state_id)->get();
        
        return response()->json($platform);
    }
    public function diameterData($id)
    {
        $platform =Diameter::where('brand_id', $id)->get();
        return response()->json($platform);
    }
