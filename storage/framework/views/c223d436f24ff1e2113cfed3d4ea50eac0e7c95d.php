...
<head>
    ...
    <meta name="description"
        content="<?php echo e(isset($meta_description) ? $meta_description : get_option('meta_description')); ?>" />
    <!-- Favicon -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/theme/myweb/css/slick.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/theme/myweb/css/slick-theme.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/theme/myweb/css/aos.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/theme/myweb/css/bootstrap.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/theme/myweb/css/style.css')); ?>">
...
<body>
    ...
    <?php if(\Session::has('success')): ?>
        <div class="alert alert-success rounded-0">
            ...
            <p class="text-center m-0 text-white"><?php echo e(session('success')); ?></p>
        </div>
    <?php endif; ?>
    <?php if(\Session::has('error')): ?>
        <div class="alert alert-success rounded-0">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <p class="text-center m-0 text-white"><?php echo e(session('error')); ?></p>
        </div>
    <?php endif; ?>
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg ">
                        <div class="container-fluid">
                           <div class="nav-icons">
                           <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img class="img-fluid"
                                    src="<?php echo e(asset('public/theme/myweb/images/id2-header-logo.png')); ?>" alt="logo"></a>
                             <div class="icons">
                                    <?php if(Auth::check()): ?>
                                        <a href="<?php echo e(url('sign_out')); ?>" class="btn btn-secondary mobileSignbtn">Log Out</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('signup')); ?>" class="btn btn-secondary mobileSignbtn">
                                            Sign-in / Sign-up
                                        </a>
                                    <?php endif; ?>
                                ...
                                <ul class="navbar-nav mb-2 mb-lg-0">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li> <a class="dropdown-item <?php echo e(request()->is('about') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('about')); ?>">About Us</a></li>
                                            <li> <a class="dropdown-item "
                                                href="<?php echo e(route('benefits')); ?>">Why Partner</a></li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e(request()->is('faq') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('faqs')); ?>">FAQs</a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo e(request()->is('testimonials') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('testimonials')); ?>">testimonials</a>
                                    </li>
                                    ...
                                    <?php if(Auth::check()): ?>
                                        <?php if($doctor && Auth::user()->user_status == 'Dental_Specialist'): ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo e(request()->is('doctor_register_portal') ? 'active' : ''); ?>"
                                                    href="<?php echo e(url('doctor_register_portal')); ?>">Doctor
                                                    Dashboard</a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if(Auth::check()): ?>
                                        <?php if(Auth::user()->user_status == 'patient'): ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo e(request()->is('doctor_register_portal') ? 'active' : ''); ?>"
                                                    href="<?php echo e(url('doctor_register_portal')); ?>">Patient
                                                    Dashboard</a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    ...
                                    <?php if(Auth::check()): ?>
                                        <a href="<?php echo e(url('sign_out')); ?>" class="btn btn-secondary MB-NONE">Log Out</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('signup')); ?>" class="btn btn-secondary MB-NONE">
                                            Sign-in / Sign-up
                                        </a>
                                    <?php endif; ?>
                                </ul>
        ...
        <div class="container">
            <div class="sec-newsletter" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
                <div class="row">
                    ...
                    <!--                    src="<?php echo e(asset('public/theme/myweb/images/send-icon.png')); ?>" alt="image">-->
                    <!--            </a>-->
                    <!--        </div>-->
                    <!--    </form>-->
                    <!--</div>-->
            ...
            <div class="top-footer">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="" data-aos="slide-right" data-aos-delay="50" data-aos-duration="1000">
                            <a href="" class="logo navbar-brand"> <img
                                    src="<?php echo e(asset('public/theme/myweb/images/logo.png')); ?>" alt="image"
                                    class='img-fluid'></a>
                        <div  class="call-now">
                            Call Us Today <br>
                            <a href="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="links-content" data-aos="zoom-in" data-aos-delay="50" data-aos-duration="1000">
                            ...
                            <ul>
                                ...
                                <li>
                                     <a href="<?php echo e(route('benefits')); ?>">Why Partner</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo e(url('testimonials')); ?>">Testimonial</a>
                                </li>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="links-content" data-aos="zoom-in" data-aos-delay="50" data-aos-duration="1000">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo e(url('termsandcondition')); ?>">Terms & Conditions</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('privacypolicy')); ?>">Privacy Policy</a>
                                </li>
                                <li>
                    ...
                    <ul class="social-links">
                                <li>
                                    <a href="<?php echo e(get_option('facebook_link')); ?>" target="blank"><i class="fa-brands fa-facebook-f"></i></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(get_option('twitter_link')); ?>" target="blank"><i class="fa-brands fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(get_option('instagram_link')); ?>" target="blank"><i class="fa-brands fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(get_option('youtube_link')); ?>" target="blank"><i class="fa-brands fa-youtube"></i></a>
                                </li>
                                <li>
    ...
    <!-- /End Footer Area -->
    <script src="<?php echo e(asset('public/theme/myweb/js/jquery.js')); ?>"></script>
    <script src="<?php echo e(asset('public/theme/myweb/js/slick.js')); ?>"></script>
    <script src="<?php echo e(asset('public/theme/myweb/js/bootstrap.js')); ?>"></script>
...
<?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/website.blade.php ENDPATH**/ ?>