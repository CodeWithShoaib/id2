...
<head>
    ...
    <style type="text/css">
        ...
        .inner-banner {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(<?php echo e(asset('public/uploads/media/file_64adca43ad735.jpg')); ?>) center center/cover no-repeat;
        }
...
<?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/userDashboard/header.blade.php ENDPATH**/ ?>