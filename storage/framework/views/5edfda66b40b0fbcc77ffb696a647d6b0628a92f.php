...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e('public/backend/images/favicon.png'); ?>">
    ...
    <style type="text/css">
        ...
        .inner-banner {
            background: url(<?php echo e(asset('public/uploads/media/file_64adca43ad735.jpg')); ?>) center center/cover no-repeat;
        }
    </style>
                                ...
                                <div class="user-profile">
                                    <h4 class="user-name dropdown-toggle" data-toggle="dropdown">
                                        <img class="avatar user-thumb" id="my-profile-img"
                                            src="<?php echo e(asset('public/uploads/profile/default.png')); ?>" alt="avatar"> <i
                                ...
                                <div class="seo-fact sbg1">
                                    <div class="p-4">
                                        <div class="seofct-icon">
                                            <span><?php echo e($patiente->fname); ?> <?php echo e($patiente->lname); ?> Implant Report </span>
                                        </div>
                                                ...
                                                <div class='row hidingWhilePrint'>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control"
                                                                value="<?php echo e($patiente->fname ?? ''); ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control"
                                                                value="<?php echo e($patiente->lname ?? ''); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control "
                                                                value="<?php echo e($patiente->streesAddress ?? ''); ?>">
                                                        </div>
                                                    </div>
                                                    <?php
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control "
                                                                value="<?php echo e($country->name ?? 'N/A'); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control "
                                                                value="<?php echo e($State->name ?? 'N/A'); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control"
                                                                value="<?php echo e($city->name ?? 'N/A'); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <?php for($i = 0; $i < $teeth_count; $i++): ?>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <h5 style="text-transform: capitalize">
                                                                            <?php echo e($dental_implant[$i]); ?>: </h5>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" readonly
                                                                            class="form-control "
                                                                            value="<?php echo e($doctor_name[$i] ?? 'N/A'); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" readonly
                                                                            class="form-control "
                                                                            value="<?php echo e($practice_name_of_restoring_dentist[$i] ?? 'N/A'); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                ?>
                                                                <?php if($manufactures[$i]): ?>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="control-label"><?php echo e(_lang('Manufacturer')); ?></label>
                                                                            <input type="text" readonly
                                                                                class="form-control "
                                                                ...
                                                                <?php if($brand): ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="control-label"><?php echo e(_lang('Brand / Model')); ?></label>
                                                                ...
                                                                <?php if($platform): ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="control-label"><?php echo e(_lang('Size / Diameter')); ?></label>
                                                                            <input type="text" readonly
                                                                                class="form-control "
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="control-label"><?php echo e(_lang('Lot Number')); ?></label>
                                                                        <input type="text" readonly
                                                                            class="form-control "
...
<?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/userDashboard/share.blade.php ENDPATH**/ ?>