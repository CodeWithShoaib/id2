...
<script src="<?php echo e('public/backend/plugins/moment/moment.js'); ?>"></script>

<!-- Datatable js -->
<script src="<?php echo e('public/backend/plugins/datatable/datatables.min.js'); ?>"></script>

<script src="<?php echo e('public/backend/plugins/dropify/js/dropify.min.js'); ?>"></script>
<script src="<?php echo e('public/backend/plugins/sweet-alert2/sweetalert2.min.js'); ?>"></script>
<script src="<?php echo e('public/backend/plugins/select2/select2.min.js'); ?>"></script>
<script src="<?php echo e('public/backend/plugins/daterangepicker/daterangepicker.js'); ?>"></script>
<script src="<?php echo e('public/backend/plugins/tinymce/tinymce.min.js'); ?>"></script>
<script src="<?php echo e('public/backend/plugins/parsleyjs/parsley.min.js'); ?>"></script>
<script src="<?php echo e('public/backend/plugins/jquery-toast-plugin/jquery.toast.min.js'); ?>"></script>
...
<!-- Custom JS -->
<script src="<?php echo e('public/backend/plugins/chartjs/Chart.min.js'); ?>"></script>
...
<?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/userDashboard/footer.blade.php ENDPATH**/ ?>