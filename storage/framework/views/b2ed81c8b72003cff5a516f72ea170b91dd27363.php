...
.inner-banner {
    background: url(<?php echo e(asset("public/theme/myweb/images/1690317477-2023-07-25_16-35-02.jpg")); ?>) center center/cover no-repeat;
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-12">
            ...
            <!--faq_banner_heading-->
              ...
              <!--faq_banner_image-->
              <img data-aos="slide-right" data-aos-duration="1000" data-aos-delay="100" class="img-fluid banner-img" src="<?php echo e(get_option('faq_banner_img') != '' ? asset('public/uploads/media/'.get_option('faq_banner_img')) : ''); ?>" alt="">
            </div>
          </div>
        </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.myweb.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/faqs.blade.php ENDPATH**/ ?>