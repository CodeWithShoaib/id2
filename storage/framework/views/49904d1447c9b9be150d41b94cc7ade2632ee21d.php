...
<style>
.inner-banner {
    background:linear-gradient(to top, #0000003d, #000000), url(<?php echo e(asset('public/theme/myweb/images/testimnial_bg_1.jpg')); ?>) center center/cover no-repeat;
    height: 500px;
    display: flex;
    align-items: center;
    color: white;
...
.slick-prev:before {
  content : '';
    ...
    display :block;
    margin: 9px;
    background: url(<?php echo e(asset('public/theme/myweb/images/left-arrow.svg')); ?>) no-repeat;
}
...
.slick-next:before {
  content : '';
    ...
    display :block;
    margin: 9px;
    background: url(<?php echo e(asset('public/theme/myweb/images/right-arrow.svg')); ?>) no-repeat;
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="content">
                            <!--banner_heading-->
                            <h2><?php echo e(get_trans_option('testimonial_banner_heading')); ?></h2>
        ...
        <div class="testimonials">
          <div class="testimonial">
             <img src="<?php echo e(asset('public/theme/myweb/images/Charles.png')); ?>">
             <div class="details">
          ...
          <div class="testimonial">
             <img src="<?php echo e(asset('public/theme/myweb/images/Robert.png')); ?>">
             <div class="details">
...
With the continuous increase in the number of implants on the market, it is nearly impossible to identify what you are dealing with when treating new patients who had implant work done in another state or internationally.
          ...
          <div class="testimonial">
             <img src="<?php echo e(asset('public/theme/myweb/images/Nadim.png')); ?>">
             <div class="details">
...
Prosthodontist</span>
          ...
          <div class="testimonial">
          <img src="<?php echo e(asset('public/theme/myweb/images/Arnold.png')); ?>">
...
Take a serious look at the new dental implant registry, id2 and save yourself and your patients, time and money.”</p>
          ...
          <div class="testimonial">
          <img src="<?php echo e(asset('public/theme/myweb/images/dummy.png')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.myweb.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/testimonials.blade.php ENDPATH**/ ?>