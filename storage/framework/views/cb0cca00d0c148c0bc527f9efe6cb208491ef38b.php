...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="main-content-inner ">
            ...
            <form method='post' action='<?php echo e(route('update.slot', [$dental_implant_edit->id])); ?>'
                                                ...
                                                <?php for($i = 0; $i < $teeth_count; $i++): ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e(isset($doctors_name[$i]) ? $doctors_name[$i] : 'N/A'); ?>"
                                                                name="doctors_name[]">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo e(_lang('Doctor Phone Number')); ?></label>
                                                            <input type="text" class="form-control"
                                                                value="<?php echo e(isset($doctor_phone_number[$i]) ? $doctor_phone_number[$i] : 'N/A'); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control "
                                                                value="<?php echo e(isset($Implant_Restoration_date[$i]) ? $Implant_Restoration_date[$i] : 'N/A'); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control "
                                                                value="<?php echo e(isset($abutment_type[$i]) ? $abutment_type[$i] : 'N/A'); ?>"
                                                                name='abutment_type[]'>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo e(_lang('Restoration Dentist Name')); ?></label>
                                                            <input type="text" class="form-control "
                                                                value="<?php echo e(isset($restoring_dentist_name[$i]) ? $restoring_dentist_name[$i] : 'N/A'); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manufactures[]"
                                                                id="Manufactures<?php echo e($i); ?>"
                                                                onchange="get_brand_data(<?php echo e($i); ?>)"
                                                                class="form-select form-control Manufactures">
                                                                <?php $__currentLoopData = $manufacture_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value='<?php echo e($item->manufacturer_id); ?>'
                                                                        <?php echo e($item->manufacturer_id == $manufactures[$i] ? 'selected' : $manufactures[$i]); ?>>
                                                                        <?php echo e($item->manufacturer_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                            <input type="text" name=""
                                                                class="form-control Manufactures" style="display: none;"
                                                                id="hiddenManufactures<?php echo e($i); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label"><?php echo e(_lang('Current Manufacture')); ?></label>
                                                            <?php
                                                            ...
                                                            <input type="text" class="form-control Manufactures"
                                                                value='<?php echo e($m->manufacturer_name ?? $manufactures[$i]); ?>'>
                                                        </div>
                                                    </div>
                                                    <?php if($brand): ?>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="brand[]" id="Brand_<?php echo e($i); ?>"
                                                                    onchange="get_diameter_data(<?php echo e($i); ?>)"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label
                                                                    class="control-label"><?php echo e(_lang('Current Brand')); ?></label>
                                                                <?php
                                                                    $b = App\Brand::where('brand_id', $brand[$i])->first();
                                                                ?>
                                                                <input type="text" class="form-control"
                                                                    value='<?php echo e($b->brand_name ?? $brand[$i]); ?>'
                                                                    placeholder="Enter Another Brand">
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if(isset($brand[$i])): ?>
                                                        <?php if($platform): ?>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="platform[]"
                                                                        id="platform_<?php echo e($i); ?>"
                                                                        class="form-select form-control Platform">
                                                                        <option value=""></option>
                                                                    </select>
                                                                    <input type="text" name=""
                                                                        class="form-control" style="display: none;"
                                                                        id="hiddenPlatform<?php echo e($i); ?>"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label">Current Platform
                                                                        size/Diameter:</label>
                                                                    <input type="text" class="form-control"
                                                                        value='<?php echo e($p->delimiter_name ?? $platform[$i]); ?>'
                                                                        placeholder="Enter Another Brand">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="file" id="selectImage"
                                                                name="images<?php echo e($i + 1); ?>[]" multiple>
                                                            <input type="hidden" value='<?php echo e($teeth_no); ?>'
                                                                name='tooth_ids[]'>
                                                        </div>
                                                    </div>
...
<?php /**PATH /home/betarwreality/public_html/resources/views/theme/myweb/userDashboard/editSlot.blade.php ENDPATH**/ ?>