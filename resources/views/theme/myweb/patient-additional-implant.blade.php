            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="content">
                            <h2> Addional Implant<small class="id2-text">(s)</small></h2>
                            <img data-aos="slide-right" data-aos-duration="1000" data-aos-delay="100" class="img-fluid banner-img"
                            src="{{asset('public/theme/myweb/images/banner-img-1.png')}}" alt="image">
                        </div>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-12 text-center">
                <div class="doctor_register_portal_heading">
                    <h2>Patient <span>Additional</span> Implant</h2>
                </div>
            </div>
