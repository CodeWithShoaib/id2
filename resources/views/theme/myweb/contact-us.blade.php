...
.inner-banner {
    ...
    background: url({{ get_option('contact_us_background_img') != '' ? asset('public/uploads/media/'.get_option('contact_us_background_img')) : '' }}) center center/cover no-repeat;
}
</style>
    <main>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="content">
                            ...
                            <h2>{{ get_trans_option('contact_us_banner_heading') }}</h2>
                            <!--contact_us_banner_image-->
                            <img data-aos="slide-right" data-aos-duration="1000" data-aos-delay="100" class="img-fluid banner-img"
                            src="{{ get_option('contact_banner_img') != '' ? asset('public/uploads/media/'.get_option('contact_banner_img')) : '' }}" alt="image">
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row justify-content-center d-flex">
                        <div class="col-12 col-lg-12 justify-content-center d-flex">
                            ...
                            <h1 data-aos="zoom-out" data-aos-duration="1000" data-aos-delay="200">{!! get_trans_option('after_contact_heading') !!}</h1>
                        </div>
