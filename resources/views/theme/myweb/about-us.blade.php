...
.about-main-banner {
    background: url({{ get_option('about_banner_background_img') != '' ? asset('public/uploads/media/'.get_option('about_banner_background_img')) : '' }}) center center/cover no-repeat !important;
}
.first-heading{
    font-size : 44px ;
}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="content">
                            <!--banner_heading-->
                            <h2>{{ get_trans_option('banner_heading') }}</h2>
                            <!--about_banner_img-->
