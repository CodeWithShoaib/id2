...
.inner-banner {
    ...
    background: url({{ get_option('about_banner_background_img') != '' ? asset('public/uploads/media/'.get_option('about_banner_background_img')) : '' }}) center center/cover no-repeat;
    height: 500px;
    display: flex;
    align-items: center;
    color: white;
...
.about-inner-banner {
    ...
    background: linear-gradient(#00000094,#00000094),   url({{ get_option('bottom_background_img') != '' ? asset('public/uploads/media/'.get_option('bottom_background_img')) : '' }}) center center/cover no-repeat !important;
    color: var(--white);
}
.about-main-banner {
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="content">
                            ...
                            <h2>Your Benefits</h2>
                            <!--about_banner_img-->
                            <img data-aos="slide-right" data-aos-duration="1000" data-aos-delay="100" class="img-fluid banner-img" src="{{ get_option('about_banner_img') != '' ? asset('public/uploads/media/'.get_option('about_banner_img')) : '' }}" alt="image">
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6 " >
                        ...
                        <ul>
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-1.png') }}" alt="">
                         <div class="content2">
                             <h5>PROACTIVE:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-2.png') }}" alt="">
                         <div class="content2">
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-3.png') }}" alt="">
                         <div class="content2">
                             <h5>CONSOLIDATION:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-4.png') }}" alt="">
                         <div class="content2">
                             <h5>TRANSPARENCY:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-5.png') }}" alt="">
                         <div class="content2">
                             <h5>ACCURATE: </h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-6.png') }}" alt="">
                         <div class="content2">
                             <h5>EMPOWERMENT: </h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-7.png') }}" alt="">
                         <div class="content2">
                             <h5>UNLIMITED: </h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-8.png') }}" alt="">
                         <div class="content2">
                    ...
                    <div class="col-12 col-lg-6" >
                      ...
                      <ul>
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/Patients-icon-1.png') }}" alt="">
                         <div class="content2">
                             <h5>AWARENESS:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/Patients-icon-2.png') }}" alt="">
                         <div class="content2">
                             <h5>EFFICIENCY:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon icon-patient-3" src="{{ asset('public/theme/myweb/images/Patients-icon-3.png') }}" alt="">
                         <div class="content2">
                             <h5>SECURE / ANYTIME ACCESS:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon icon-patient-5" src="{{ asset('public/theme/myweb/images/Patients-icon-4.png') }}" alt="">
                         <div class="content2">
                        ...
                        <li>
                                 <img class="img-fluid icon icon-patient-5" src="{{ asset('public/theme/myweb/images/Patients-icon-5.png') }}" alt="">
                         <div class="content2">
                             <h5>UNLIMITED:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/Patients-icon-6.png') }}" alt="">
                         <div class="content2">
                             <h5>RECORDS:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/Patients-icon-7.png') }}" alt="">
                         <div class="content2">
                             <h5>EDUCATION:</h5>
                        ...
                        <li>
                                 <img class="img-fluid icon" src="{{ asset('public/theme/myweb/images/benefit-icon-14.png') }}" alt="">
                         <div class="content2">
                             <h5>INVESTMENT:</h5>
