...
@section('content')
    ...
    <style>
        ...
        .sec-service-bg {
            background: linear-gradient(to right, #00000063, #0000003b), url({{ asset('public/theme/myweb/images/sergury-bg.jpg') }}) center center/cover no-repeat;
            padding: 100px 0px 100px 0;
            color: var(--white);
        }

        .sec-sergury-bg {
            /* background: linear-gradient(to right, #000000c4, #000000b3), url({{ get_option('back_sergury') != '' ? asset('public/uploads/media/' . get_option('back_sergury')) : '' }}) center center/cover no-repeat; */
            /* text-align: center; */
            /* color: var(--white); */
            /* padding-top: 100px; */
            /* height: 670px; */
        ...
        .sec-testimonial {
            background: url({{ get_option('back_testimonial') != '' ? asset('public/uploads/media/' . get_option('back_testimonial')) : '' }}) center center/cover no-repeat;
            padding: 100px 0;
            position: relative;
            z-index: 1;
        }
        ...
        .sec-form-bg {
            background: url({{ get_option('contact_back_img') != '' ? asset('public/uploads/media/' . get_option('contact_back_img')) : '' }}) center center/cover no-repeat;
            padding-bottom: 68px;
            position: relative;
        }
        ...
        .sec-hero {
            background: linear-gradient(#00000054, #00000073), url({{asset('public/uploads/media/file_64adca43ad735.jpg')}}) center center/cover no-repeat;
            position: relative;
            height: 900px;
        }
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="images">
                            <img class="img-fluid" src="{{ asset('public/theme/myweb/images/iphone.png') }}" alt="">
                            <img class="img-fluid" src="{{ asset('public/theme/myweb/images/iphone4.png') }}"
                                alt="">
                        </div>
                    ...
                    <!--    src="{{ get_option('banner_img') != '' ? asset('public/uploads/media/' . get_option('banner_img')) : '' }}"-->
                    <!--    alt="image">-->
                    <!--side_content-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="circle-teeth-img-p">
                            <img src="{{ asset('public/theme/myweb/images/teeth-in-circle.png') }}" alt=""
                                class="img-fluid">
                        </div>
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="text-center mt-lg-5 ">
                        ...
                        <a href="{{url('signup')}}" class="btn btn-primary">Sign-in / Sign-Up</a>
        ...
        <section class="sec-about" id="aboutSec">
            <div class="container">
                <div class="row" style="position: relative; overflow: hidden;">
                    ...
                    <!--	<div class="content"> <img data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100" class="about-img aos-init aos-animate" src="{{ get_option('about_img') != '' ? asset('public/uploads/media/' . get_option('about_img')) : '' }}" alt="">-->
                    ...
                    <!--          <div class="dent-icon aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"> <img class="img-fluid" src="{{ asset('public/theme/myweb/images/tooth.png') }}" alt=""> </div>-->
                    ...
                    <!--		 <a href="{{ url('about') }}" data-aos="slide-left" data-aos-delay="50" data-aos-duration="1000" class="btn btn-primary aos-init aos-animate">read more</a> </div>-->
                    <!--</div>-->
                </div>
            </div>
            <div class="sec-service">
                <!-- <div class="services-bg">
                                <img class="img-fluid services-bg-img" src="{{ asset('public/theme/myweb/images/yendex1.png') }}" alt="">
                            </div> -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="content">
                            ...
                            <h3>Patient Centric
                                <img class="img-fluid"
                                    src="{{('public/theme/myweb/images//tooth.png')}}" alt="image">
                                Implant Agnostic
                            </h3>
                            ...
                            <a href="{{ route('benefits') }}" class="btn btn-primary">read more</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="mb-images">
                            ...
                            <!--    src="{{ asset('public/theme/myweb/images/firstmobile.png') }}" alt="">-->
                            <img data-aos="slide-left" data-aos-duration="1000" data-aos-delay="200"
                                class="img-fluid aos-init aos-animate"
                                src="{{ asset('public/theme/myweb/images/secondmobile.png') }}" alt="">
                            <img data-aos="slide-left" data-aos-duration="1000" data-aos-delay="200"
                                class="img-fluid aos-init aos-animate"
                                src="{{ asset('public/theme/myweb/images/thirdmobile.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content_3">
                            ...
                            <img class="img-fluid logo" src="{{ asset('public/theme/myweb/images/logo-dark.png') }}"
                                alt="logo">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card card-resolution aos-init" data-aos="flip-left" data-aos-duration="1000"
                                data-aos-delay="100">
                                <div class="card-img-top">
                                    <img src="{{ asset('public/theme/myweb/images/resolution-img-1.png') }}"
                                        class="img-fluid" alt="...">
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="{{url('signup')}}" class="btn btn-primary">Implant
                                        Complications?</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card card-resolution aos-init" data-aos="flip-left" data-aos-duration="1000"
                                data-aos-delay="100">
                                <div class="card-img-top">
                                    <img src="{{ asset('public/theme/myweb/images/resolution-img-2.png') }}"
                                        class="img-fluid" alt="...">
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Being able to identify the brand and size specifics of a dental
                                        ...
                                        instantaneous.</p>
                                    <a href="{{url('signup')}}" class="btn btn-primary">Share Your
                                        Registry</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card card-resolution aos-init" data-aos="flip-left" data-aos-duration="1000"
                                data-aos-delay="100">
                                <div class="card-img-top">
                                    <img src="{{ asset('public/theme/myweb/images/resolution-img-3.png') }}"
                                        class="img-fluid" alt="...">
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="{{url('signup')}}" class="btn btn-primary">Repair the
                                        Complication </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="card card-resolution aos-init" data-aos="flip-left" data-aos-duration="1000"
                                data-aos-delay="100">
                                <div class="card-img-top">
                                    <img src="{{ asset('public/theme/myweb/images/resolution-img-4.png') }}"
                                        class="img-fluid" alt="...">
                                </div>
                                <div class="card-body">
                                    <p class="card-text">A quick resolution lets a patient get back to enjoying life!
                                    </p>
                                    <a href="{{url('signup')}}" class="btn btn-primary">Savor your
                                        moments</a>
                                </div>
                            </div>
        ...
        <!--</p>-->
        <!--          {!! get_trans_option('testimonial_content') !!}-->

        <!--        </div>-->
        <!--      </div>-->
        <!--      <div class="testimonial-slider">-->
        <!--        <div class="card card-testimonail">-->
        <!--          <img src="{{ asset('public/theme/myweb//images/client-img-1.png') }}" class="client-img" alt="...">-->
        <!--          <div class="card-body">-->
        <!--            <h5 class="card-title">Lorem Ipsum</h5>-->
        <!--            <p class="card-text-sm">Doloremque</p>-->
        <!--            <img class="stars" src="{{ asset('public/theme/myweb/images/stars.png') }}" alt="image">-->
        ...
        <!--      <div class="col-12">-->
        <!--brand_img-->
        <!--        <img class="brands-img img-fluid" src="{{ get_option('brand_image') != '' ? asset('public/uploads/media/' . get_option('brand_image')) : '' }}" alt="image">-->
        <!--      </div>-->
        <!--    </div>-->
        <!--  </div>-->
        <!--</section>-->
        ...
        <!--      <img class="img-fluid pngwing-img" src="{{ asset('public/theme/myweb/images/pngwing-img.png') }}" alt="" data-aos="slide-left" data-aos-duration="2000" data-aos-delay="300">-->
        ...
        <!--            <h5>{!! get_trans_option('get_in_touch_heading') !!}</h5>-->
        <!--contact_heading-->
        <!--            <h3>{!! get_trans_option('contact_heading') !!}</h3>-->
        <!--          </div>-->
        ...
        <section class="sec-sergury-bg">
            ...
            <img class="did-you-know-img img-fluid" src="{{ asset('public/theme/myweb/images/did-you-know.png') }}"
                alt="...">
        </section>
    </main>
