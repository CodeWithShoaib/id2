...
<li><a href="{{ route('brands.index') }}"><i class="ti-ticket"></i> <span>{{ _lang('Testimonial') }}</span></a></li>
<li><a href="{{ route('coupons.index') }}"><i class="ti-ticket"></i> <span>{{ _lang('Packages') }}</span></a></li>
<li><a href="{{ route('doctor.list') }}"><i class="ti-ticket"></i> <span>{{ _lang('Doctor List') }}</span></a></li>
<li><a href="{{ route('patient.list') }}"><i class="ti-ticket"></i> <span>{{ _lang('Patient List') }}</span></a></li>
<li><a href="{{ url('admin/slotList') }}"><i class="ti-ticket"></i> <span>{{ _lang('Payment List') }}</span></a></li>
...
<li>
    <a href="javascript: void(0);"><i class="ti-desktop"></i><span>{{ _lang('Website Settings') }}</span><span
            class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
    <ul class="nav-second-level" aria-expanded="false">
        <li class="nav-item"><a class="nav-link"
                href="{{ route('theme_option.update', 'theme_settings') }}">{{ _lang('Theme Settings') }}</a></li>
        <!--<li class="nav-item"><a class="nav-link" href="{{ route('theme_option.update', 'home_page_settings') }}">{{ _lang('Page Settings') }}</a></li>-->
    </ul>
</li>
