                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="{{ url('admin/dashboard') }}"><i class="ti-dashboard"></i>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="selectLanguage">
                                        @foreach (get_language_list() as $language)
                                            <a class="dropdown-item"
                                                href="{{ url('select_language/' . $language) }}">{{ $language }}</a>
                                        @endforeach
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="user-profile">
                                    <h4 class="user-name dropdown-toggle" data-toggle="dropdown">
                                        <img class="avatar user-thumb" id="my-profile-img"
                                            src="{{ profile_picture() }}" alt="avatar"> {{ Auth::user()->name }}
                                        <i class="fa fa-angle-down"></i>
                                    </h4>
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ url('admin/profile/change_password') }}"><i
                                                class="ti-pencil text-muted mr-2"></i>
                                            {{ _lang('Change Password') }}</a>
                                        <div class="dropdown-divider mb-0"></div>
                                        <a class="dropdown-item" href="{{ url('userLogout') }}"><i
                                                class="ti-power-off text-muted mr-2"></i> {{ _lang('Logout') }}</a>
                                    </div>
                                </div>
                            </li>
