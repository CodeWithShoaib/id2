            ...
            <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 auto-multiple-select"
                                                data-selected="{{ get_setting($settings, 'supported_countries') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ get_setting($settings, 'backend_direction', 'ltr') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ get_setting($settings, 'email_verification', 'disabled') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="media_file_types_supported"
                                                value="{{ get_setting($settings, 'media_file_types_supported', 'png,jpg,jpeg') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                class="control-label">{{ _lang('Media Max Upload Size in MB') }}</label>
                                            <small
                                                class="float-right">{{ _lang('Max') . ' ' . @ini_get('upload_max_filesize') . ' ' . _lang('Supported by your server') }}</small>
                                            <input type="text" class="form-control" name="media_max_upload_size"
                                                value="{{ get_setting($settings, 'media_max_upload_size', 2) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                class="control-label">{{ _lang('Digital File Max Upload Size in MB') }}</label>
                                            <small
                                                class="float-right">{{ _lang('Max') . ' ' . @ini_get('upload_max_filesize') . ' ' . _lang('Supported by your server') }}</small>
                                            <input type="text" class="form-control"
                                                name="digital_file_max_upload_size"
                                                value="{{ get_setting($settings, 'digital_file_max_upload_size', 2) }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ get_setting($settings, 'currency_converter', 'manual') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                class="control-label">{{ _lang('Fixer API Key') . ' (' . _lang('Currency Converter') . ')' }}</label>
                                            <a href="https://fixer.io/" target="_blank"
                                                class="btn-link pull-right">{{ _lang('GET API KEY') }}</a>
                                            <input type="text" class="form-control" name="fixer_api_key"
                                                value="{{ get_setting($settings, 'fixer_api_key') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ get_setting($settings, 'currency_position', 'left') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control auto-select"
                                                data-selected="{{ get_setting($settings, 'mail_type', 'smtp') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control smtp auto-select"
                                                data-selected="{{ get_setting($settings, 'smtp_encryption', 'ssl') }}"
                                            ...
                                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('PayPal Mode') }}</label>
                                                            <select class="form-control auto-select"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Description') }}</label>
                                            ...
                                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ get_setting($settings, 'stripe_description', 'Pay Via Credit Card') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Secret Key') }}</label>
                                                            <input type="text" class="form-control"
                                            ...
                                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Enable Razorpay') }}</label>
                                                            <select class="form-control auto-select"
                                                                data-selected="{{ get_setting($settings, 'razorpay_active', 'No') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="razorpay_label"
                                                                value="{{ get_setting($settings, 'razorpay_label', 'Razorpay') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ get_setting($settings, 'razorpay_description') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ get_setting($settings, 'razorpay_key_id') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Key Secret') }}</label>
                                                            <input type="text" class="form-control"
                                                                name="razorpay_key_secret"
                                                                value="{{ get_setting($settings, 'razorpay_key_secret') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                            ...
                                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Enable Paystack') }}</label>
                                                            <select class="form-control auto-select"
                                                                data-selected="{{ get_setting($settings, 'paystack_active', 'No') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="paystack_label"
                                                                value="{{ get_setting($settings, 'paystack_label', 'Paystack') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ get_setting($settings, 'paystack_description') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Public Key') }}</label>
                                                            <input type="text" class="form-control"
                                                                name="paystack_public_key"
                                                                value="{{ get_setting($settings, 'paystack_public_key') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ get_setting($settings, 'paystack_secret_key') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                            ...
                                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Enable Cash On Delivery') }}</label>
                                                            <select class="form-control auto-select"
                                                                data-selected="{{ get_setting($settings, 'cod_active', 'No') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="cod_label"
                                                                value="{{ get_setting($settings, 'cod_label', 'Cash On Delivery') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                            ...
                                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">{{ _lang('Enable Bank Transfer') }}</label>
                                                            <select class="form-control auto-select"
                                                                data-selected="{{ get_setting($settings, 'bank_transfer_active', 'No') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ get_setting($settings, 'bank_transfer_label', 'Bank Transfer') }}"
                                                                required>
                                                        </div>
                                                    </div>
                ...
                <div id="mailchimp_settings" class="tab-pane fade">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="settings-submit params-panel" autocomplete="off"
                                action="{{ route('theme_option.update', ['general_settings', 'store']) }}">
                                {{ csrf_field() }}
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label>
                                                ...
                                                <input type="checkbox" value="1" name="enable_newsletter"
                                                    {{ get_option('enable_newsletter') == 1 ? 'checked' : '' }}>
                                                {{ _lang('Enable Newsletter') }}
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Newsletter_title"
                                                value="{{ get_trans_option('Newsletter_title') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="MAILCHIMP_APIKEY"
                                                value="{{ get_setting($settings, 'MAILCHIMP_APIKEY') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="MAILCHIMP_LIST_ID"
                                                value="{{ get_setting($settings, 'MAILCHIMP_LIST_ID') }}">
                                        </div>
                                    </div>
